class Sct < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "b4d67a4beb22d2f7cc19760fa2a8e50cb4faf9f1a8485b4fa4bc880ad3a7e278"
    else
      url "https://github.com/pacharanero/sct/releases/download/v#{version}/sct-macos-x86_64.tar.gz"
      sha256 "104a0e5d901851064eaa7a4558247bccdfe8234693e4e11a701e363397e231bd"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "07ef9cffc7b303082d7fe2c3cbd7c61b7742fffacf9405e80b9e366eeb78f352"
    else
      url "https://github.com/pacharanero/sct/releases/download/v#{version}/sct-linux-x86_64.tar.gz"
      sha256 "a97adffd4ea743fd0f5a48657e5b540b994d03d86667bebd433287035ad5bdf9"
    end
  end
